...
const WildfireCamPrediction = () => {
  ...
  return (
    ...
    className="w-full min-h-screen bg-gray-100 flex flex-col items-center p-6 ">
        ...
        <div className="w-full lg:w-1/2 flex flex-col items-center justify-center p-6">
          ...
          {result ? (
            <div className="w-full flex flex-col items-center">
              <div className="w-full mb-8 border-2 border-dashed border-gray-500 rounded-lg p-4">
                <img
            ...
            <div className="w-full flex flex-col items-center">
              <div className="w-full mb-8 border-2 border-dashed border-gray-500 rounded-lg p-4 flex items-center justify-center">
                <span className="text-center font-bold font-serif text-black">Output Result</span>
              </div>
            </div>
          )}
        </div>
      ...
      {/* Prediction Details Card - Now properly below */}
      {result && (
        <div className="w-full max-w-screen-xl p-6  shadow-lg rounded-lg ">
          ...
          <div className="mb-4">
            ...
            <p
              className={`text-2xl font-bold mt-2 ${
                result.predictionResult === "Severe Fire"
                  ? "text-red-600"
                  : "text-green-600"
              }`}
            >
          ...
          <div className="mb-4">
            ...
            <p className="text-sm text-right mt-1">{result.noWildfireConfidence}%</p>
          </div>
          ...
          <div className="mb-4">
            ...
            <p className="text-sm text-right mt-1">{result.wildfireConfidence}%</p>
          </div>
        </div>
      )}
    </div>
